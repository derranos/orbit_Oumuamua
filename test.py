...
def propagate_state(r0, v0, dt, mu):
    """
    Универсальный пропагатор (работает для Ellipse, Hyperbola, Parabola).
    ...
    while abs(ratio) > 1e-7 and iter_count < 100:
        ...
        # Производная функции времени по chi равна r(chi)
        # r(chi) = r0*G0 + ... это сложно. 
        # Используем проверенную формулу Валладо:
...
with open(CSV_FILENAME, 'r', encoding='utf-8') as f:
    ...
    for row in reader:
        ...
        # Для красоты выводим дни, но считаем в секундах
